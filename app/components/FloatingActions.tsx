    ...
    <>
      ...
      <div className="hidden lg:flex fixed right-5 bottom-6 z-50 flex-col gap-3">
        <a
          ...
          target="_blank"
          aria-label="WhatsApp"
          className="w-14 h-14 bg-[#25D366] rounded-full shadow-[0_8px_24px_rgba(37,211,102,0.4)] flex items-center justify-center text-white hover:scale-105 transition"
        >
        ...
        <a
          href="tel:9323581437"
          aria-label="Call"
          className="w-14 h-14 bg-[#C5A253] rounded-full shadow-[0_8px_24px_rgba(197,162,83,0.4)] flex items-center justify-center text-[#0A1931] hover:scale-105 transition"
        >
      ...
      <div className="lg:hidden fixed bottom-0 left-0 right-0 z-50 bg-white border-t border-slate-200 shadow-[0_-4px_20px_rgba(0,0,0,0.1)] flex">
        <a href="tel:9323581437" className="flex-1 bg-[#0A1931] text-white flex items-center justify-center gap-2 py-3.5 text-xs tracking-[0.12em] uppercase font-bold">
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"/></svg>
          Call Now
        </a>
        <a href={waLink} target="_blank" className="flex-1 bg-[#25D366] text-white flex items-center justify-center gap-2 py-3.5 text-xs tracking-[0.12em] uppercase font-bold">
        ...
        <a href="/contact" className="flex-1 bg-[#C5A253] text-[#0A1931] flex items-center justify-center gap-2 py-3.5 text-xs tracking-[0.12em] uppercase font-bold">
          Get Quote
        </a>
      </div>
    </>
