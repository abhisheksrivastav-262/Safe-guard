  ...
  return (
    <>
      ...
      <div className="lg:hidden fixed bottom-0 left-0 right-0 z-50 bg-white border-t border-slate-200 shadow-[0_-4px_20px_rgba(0,0,0,0.12)] flex pb-[env(safe-area-inset-bottom)]">
        <a href="tel:9323581437" className="flex-1 bg-[#0A1931] text-white flex items-center justify-center gap-1.5 py-3.5 min-h-[52px] text-[11px] tracking-[0.08em] sm:tracking-[0.12em] uppercase font-bold active:bg-[#132D4F] touch-manipulation">
