  ...
  return (
    <div className="max-w-3xl mx-auto p-6">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-2xl font-bold text-[#0A1931]">Add Hero Slide</h1>
          <p className="text-sm text-slate-500">Create a new background slide for the homepage banner.</p>
        </div>
        <Link
          href="/admin/hero"
      ...
      <form action={createSlide} className="bg-white p-6 rounded-lg shadow-sm border border-slate-200 space-y-6">
        <ImageUploader name="image_url" folder="hero" label="Background Image" />
        ...
        <div>
          ...
          <input
            ...
            name="title"
            required
            placeholder="e.g. SECURITY THAT PROTECTS."
        ...
        <div>
          ...
          <input
            ...
            placeholder="e.g. SERVICES THAT PERFORM."
        ...
        <div>
          ...
          <textarea
            name="subtitle"
            rows={3}
            placeholder="e.g. Professional security, facility management, technical maintenance..."
            className="w-full p-2.5 border border-slate-300 rounded focus:ring-2 focus:ring-[#C5A253] outline-none text-sm"
          />
        </div>
