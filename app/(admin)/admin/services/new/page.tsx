...
export default async function NewServicePage() {
  async function createService(formData: FormData) {
    ...
    // Basic implementation for now, ignoring image_url upload logic which needs a client component
  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      <form action={createService} className="bg-white p-6 rounded-lg shadow-sm border border-slate-200 space-y-4">
        <div>
